...
const EditBook = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post(`${configs.host}/api/category`, data);
  ...
  return (
    <div>
      <div className='okokok'>
        <Link href="/admin/category" className='aaaaaaa'>
    ...
    <div className='container-author-post'>
      ...
      <form onSubmit={handleSubmit} className='container-author-form'>
        <label>Name:</label>
        <input type="text" name="name" value={formData.name} onChange={handleChange} placeholder=' Category'/>
